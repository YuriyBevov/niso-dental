...
$APPLICATION->SetPageProperty("description", "Современная стоматологическая клиника НИСО: более 10 лет опыта, сертифицированное оборудование и команда профессионалов. Запишитесь на бесплатную консультацию: +7 (812) 509-54-25");
...
<? $APPLICATION->IncludeComponent(
	...
	[
		...
		"SORT_ORDER2" => "ASC",
		"STRICT_SECTION_CHECK" => "N",
		"COMPONENT_TEMPLATE" => "licenses-slider"
	],
	false
); ?>
