	...
	<div class="container">
		...
		<div class="footer__section footer__section--middle">
			<div class="footer__section-field">
				...
				<div class="yandex-award">
					<img src="/source/img/yandex-award-small.png" alt="Награда Хорошее место от компании Яндекс." width="23" height="32">
					<span>Хорошее место 2026</span>
				</div>
			</div>
			<div class="footer__section-field">
		...
		<div class="footer__section footer__section--bottom">
			...
			<div class="footer__section-field">
				<a class="developer-logo" href="https://t.me/+79062723744" aria-label="LittleWeb.ru - Разработка и продвижение сайтов под ключ" rel="nopener nofollow norefferer" target="_blank">
