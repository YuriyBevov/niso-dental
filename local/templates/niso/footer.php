			...
			<div class="footer__section-field">
				...
				<? $APPLICATION->IncludeComponent(
					...
					array(
						...
						"CACHE_TYPE" => "A",
						"CHECK_DATES" => "Y",
						"COMPONENT_TEMPLATE" => "awards-list",
						"DETAIL_URL" => "",
